...
export const Content = () => {
  return (
    <div className='max-container'>
        <h1 className='text-4xl py-14 font-bold gradient bg-clip-text'>Relations and Functions ( Mathematics )</h1>
        <div className='flex justify-center items-center text-2xl pb-10'>
            <ul className='flex w-1/3 justify-between gap-4 font-semibold text-[#696671] cursor-pointer'>
                <li className='border-blue-700 border-b-2 p-2'>Study</li>
                <li className='p-2'>Quiz</li>
                <li className='p-2'>Test</li>
                <li className='p-2'>Game</li>
                <li className='p-2'>Others</li>
            </ul>
        </div>
        <div className='w-1/2 h-[25rem] box m-auto'>
            ...
            <div className='flex justify-center items-center'>
                <h1 className='text-4xl font-bold text-white py-14'>9 + 6 + 7x - 2x - 3</h1>
            </div>
        </div>
        <div className='flex justify-between items-center w-1/2 m-auto py-10 px-12 cursor-pointer'>
            ...
            <div>
                <h2 className='font-bold text-2xl text-gray-700'>01/10</h2>
            </div>
            <svg width="60" height="61" viewBox="0 0 60 61" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='max-container flex justify-between'>
            <div className='flex justify-center items-center gap-3'>
                <div className='rounded-full flex justify-center items-center dif-shadow'>
                    <img className='w-[3.5rem] h-[3.5rem]' src={hyggex} alt="logo" />
                </div>
                <div>
                    <h6 className='text-[.6rem]'>Published by</h6>
                    <h2 className='text-[#06286E] text-[1.5rem]'>Hygge<span className='font-bold'>X</span></h2>
                </div>
            </div>
            <div className='flex justify-center items-center gap-2 cursor-pointer'>
                <img src={plus} alt="plus" />
                <h2 className='gradient bg-clip-text text-2xl font-bold'>Create FlashCard</h2>
            </div>
        </div>
    </div>
  )
